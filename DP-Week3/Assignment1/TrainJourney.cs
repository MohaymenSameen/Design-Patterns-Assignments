...
namespace Assignment1
{
    public class TrainJourney : ITrainJourney
    {
        ...
        public TrainJourney()
        {
            ...
            stations.Add(new TrainStation("Den Helder",1,DateTime.Parse("22:04:00"),DateTime.Parse("22:08:00")));
            stations.Add(new TrainStation("Anna Paulowna", 2, DateTime.Parse("22:14:00"), DateTime.Parse("22:15:00")));
            stations.Add(new TrainStation("Schagen", 3, DateTime.Parse("22:22:00"), DateTime.Parse("22:31:00")));
            stations.Add(new TrainStation("Heerhugowaard", 4, DateTime.Parse("22:31:00"), DateTime.Parse("22:36:00")));
